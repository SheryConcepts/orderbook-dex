...
/// @title A price-time priority matching engine / @author Nolan D. Amblard / @author Brian Goldblatt
contract MatchingEngine is OrderBook, MatchingEngineErrors, ReentrancyGuard {
    ...
    function take(uint128 tokenAmt, uint8 spendingToken1)
        external
        nonReentrant
    {
        if (spendingToken1 == 1) {
